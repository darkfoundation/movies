...
<head>
    ...
    <title>Movie Data Update - Music</title>
    ...
    <script>
        ...
        function updateMovie(oc, ll) {
            ...
            var outputURL = 'update_music.php?movie_id=' + movieId;
...
<?php
$movie_id = 1; $table = 'music'; $is_checked = '';
if (isset($_GET)) {
...
<body onload="disableBtns();" style="font-family: sans-serif"><div style="width: 500px;"><div style="text-align: center">
    <script>document.write('Music List for <b><i>' + movieTitle + '</i></b>');</script>
